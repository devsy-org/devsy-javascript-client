...
import {
  ...
  DevsySchemeGroupCluster,
  DevsySchemeGroupVirtualCluster,
  DevsySchemeVersion,
  DevsySchemeVersionCluster,
  DevsySchemeVersionVirtualCluster,
  V1Beta1PodMetrics,
} from "./types"
...
export const Resources: {
  ...
  ClusterV1SleepModeConfig: {
    group: DevsySchemeGroupCluster,
    version: DevsySchemeVersionCluster,
  ...
  VirtualclusterV1HelmRelease: {
    group: DevsySchemeGroupVirtualCluster,
    version: DevsySchemeVersionVirtualCluster,
    resource: "helmreleases",
    kind: "HelmRelease",
    namespaced: true,
  },
  ...
  StorageV1ClusterQuota: {
    group: "storage.devsy.sh",
    version: DevsySchemeVersion,
