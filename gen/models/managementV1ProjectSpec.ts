...
import { StorageV1DevsyProjectSpec } from '../models/storageV1DevsyProjectSpec';
...
export class ManagementV1ProjectSpec {
    ...
    */
    ...
    /**
    * AllowedRunners are target runners that are allowed to target with Devsy environments.
    */
    ...
    */
    'description'?: string;
    'devsy'?: StorageV1DevsyProjectSpec;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "devsy",
            "baseName": "devsy",
            "type": "StorageV1DevsyProjectSpec",
            "format": ""
        },
        {
            "name": "displayName",
