...
import { StorageV1DevsyWorkspaceTemplate } from '../models/storageV1DevsyWorkspaceTemplate';
import { V1ObjectMeta } from '../models/V1ObjectMeta';
import { V1PersistentVolumeClaim } from '../models/V1PersistentVolumeClaim';
import { V1Pod } from '../models/V1Pod';


export class ManagementV1DevsyWorkspaceInstanceTroubleshoot {
    /**
    ...
    */
    'state'?: string;
    'template'?: StorageV1DevsyWorkspaceTemplate;
    'workspace'?: ManagementV1DevsyWorkspaceInstance;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "template",
            "baseName": "template",
            "type": "StorageV1DevsyWorkspaceTemplate",
            "format": ""
        },
        {
            "name": "workspace",
            "baseName": "workspace",
            "type": "ManagementV1DevsyWorkspaceInstance",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return ManagementV1DevsyWorkspaceInstanceTroubleshoot.attributeTypeMap;
    }
