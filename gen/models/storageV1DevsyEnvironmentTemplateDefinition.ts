...
export class StorageV1DevsyEnvironmentTemplateDefinition {
    ...
    */
    'workspaceRepositoryCloneStrategy'?: StorageV1DevsyEnvironmentTemplateDefinitionWorkspaceRepositoryCloneStrategyEnum;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            ...
            "type": "StorageV1DevsyEnvironmentTemplateDefinitionWorkspaceRepositoryCloneStrategyEnum",
            "format": ""
        },
        {
    ...
    static getAttributeTypeMap() {
        return StorageV1DevsyEnvironmentTemplateDefinition.attributeTypeMap;
    }
...
export enum StorageV1DevsyEnvironmentTemplateDefinitionWorkspaceRepositoryCloneStrategyEnum {
    Empty = '',
    Blobless = 'blobless',
    Shallow = 'shallow',
    Treeless = 'treeless'
